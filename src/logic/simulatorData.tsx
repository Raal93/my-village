...
export const buildingsTimeData = () => {
  ...
  const allBuildingsTimeData = (): BuildingTimes => ({
    ratusz: [
      10, 62, 399, 828, 1374, 2067, 2948, 4068, 5491, 7300, 9599, 12520, 16233, 20952,
      26950, 34572, 44260, 56572, 72221, 92108, 117384, 149508, 190335, 242223, 308170,
      391983, 498504, 633884, 805943, 1024617,
    ],
    koszary: [
      10, 62, 399, 828, 1374, 2067, 2948, 4068, 5491, 7300, 9599, 12520, 16233, 20952,
      26950, 34572, 44260, 56572, 72221, 92108, 117384, 149508, 190335, 242223, 308170,
    ...
    stajnia: [
      10, 62, 399, 828, 1374, 2067, 2948, 4068, 5491, 7300, 8704, 10826, 13347, 16346,
      19912, 34572, 44260, 56572, 72221, 92108,
    ],
    warsztat: [
      11, 11, 228, 707, 1352, 2132, 3051, 4133, 5408, 7300, 9599, 12520, 16233, 20952,
      26950,
    ],
    pierwszyKosciol: [150],
    kosciol: [4182, 6273, 9410],
    palac: [10582],
    kuznia: [
      10, 62, 399, 707, 1352, 2132, 3051, 4068, 5491, 7300, 9599, 12520, 16233, 20952,
      26950, 34572, 44260, 56572, 72221, 92108,
    ],
    plac: [50],
    piedestal: [50],
    rynek: [
    ...
    tartak: [
      11, 12, 228, 318, 608, 959, 1373, 1860, 2434, 3112, 3917, 4872, 6006, 6400, 6800,
      7400, 7800, 8000, 8500, 9000, 9500, 11200, 13200, 16500, 19500, 22300, 26346, 31347,
      37273, 44298,
    ],
    cegielnia: [
      11, 12, 228, 318, 608, 959, 1373, 1860, 2434, 3112, 3917, 4872, 6006, 6400, 6800,
    ...
    hutaZelaza: [
      13, 14, 274, 382, 730, 1151, 1648, 2232, 2921, 3734, 4700, 5846, 7207, 7680, 8160,
      8880, 9360, 9600, 10200, 10800, 11400, 13440, 15840, 19800, 23400, 26760, 31615,
      37616, 44728, 53158,
    ],
    zagroda: [
      10, 62, 399, 828, 1374, 2067, 2948, 4068, 5491, 7300, 9599, 12520, 16233, 20952,
    ...
    schowek: [10, 62, 399, 828, 1374, 2067, 2948, 4068, 5491, 7300],
    mur: [
      10, 62, 399, 828, 1374, 2067, 2948, 4068, 5491, 7300, 9599, 12520, 16233, 20952,
      26950, 34572, 44260, 56572, 72221, 92108,
    ],
