...
export const buildingsTimeData = () => {
  ...
  const allBuildingsTimeData = (): BuildingTimes => ({
    ...
    tartak: [
      29, 32, 600, 837, 1600, 2524, 3613, 4895, 6405, 8189, 10308, 12821, 15805, 16842,
      17895, 19474, 20526, 21053, 22368, 23684, 25000, 29474, 34737, 43421, 51316, 58684,
      69332, 82492, 98087, 116574,
    ],
    cegielnia: [
      29, 32, 600, 837, 1600, 2524, 3613, 4895, 6405, 8189, 10308, 12821, 15805, 16842,
      17895, 19474, 20526, 21053, 22368, 23684, 25000, 29474, 34737, 43421, 51316, 58684,
    ...
    hutaZelaza: [
      34, 37, 721, 1005, 1921, 3029, 4337, 5874, 7687, 9826, 12368, 15384, 18966, 20211,
      21474, 23368, 24632, 25263, 26842, 28421, 30000, 35368, 41684, 52105, 61579, 70421,
      83197, 98989, 117705, 139889,
    ],
    zagroda: [
      10, 62, 399, 828, 1374, 2067, 2948, 4068, 5491, 7300, 9599, 12520, 16233, 20952,
      26950, 34572, 44260, 56572, 72221, 92108, 117384, 149508, 190335, 242223, 308170,
